...
class ProductSearchServiceTest {
    ...
    void searchProductsReturnsMappedResponse() {
        ...
        assertThat(response.products().get(0).productName()).isEqualTo("베이직 셔츠");
        assertThat(response.products().get(0).productPrice()).isEqualTo(29_000);
        assertThat(response.products().get(0).stock()).isEqualTo(10);
        assertThat(response.products().get(0).productStatus()).isEqualTo(ProductStatus.ON_SALE);
    ...
    void searchProductsMapsOutOfStockAsNotOrderable() {
        ...
        assertThat(response.products()).hasSize(1);
        assertThat(response.products().get(0).productStatus()).isEqualTo(ProductStatus.OUT_OF_STOCK);
